...
class GameController(QObject):
    ...
    def setup_timers(self) -> None:
        """Set up the countdown and question timers."""
    ...
    def start_game(self) -> None:
        ...
        if self.quiz_manager.quiz is None:
            raise ValueError("Cannot start game without a loaded quiz")
    ...
    def is_answer_legal(
        ...
        """Checks if a client's answer is legal within the game. Does not check answer correctness."""
        if (
    ...
    def reset(self) -> None:
        """Reset the game controller and quiz manager to its initial state."""
