...
class Screens(Enum):
    ...
    CLIENT_ENTRY_QUESTION = "CLIENT_ENTRY_QUESTION"
    CLIENT_ENTRY_RESULT = "CLIENT_ENTRY_RESULT"
    ...
    SERVER_ENTRY_QUESTION = "SERVER_ENTRY_QUESTION"
    SERVER_ENTRY_RESULT = "SERVER_ENTRY_RESULT"
